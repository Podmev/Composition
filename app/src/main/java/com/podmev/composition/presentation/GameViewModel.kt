...
import com.podmev.composition.domain.usecase.GenerateQuestionUseCase
import com.podmev.composition.domain.usecase.GetGameSettingsUseCase
...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _percentOrRightAnswers = MutableLiveData<Int>()
    val percentOrRightAnswers: LiveData<Int>
        get() = _percentOrRightAnswers
    ...
    private fun updateProgress() {
        ...
        _percentOrRightAnswers.value = percent
